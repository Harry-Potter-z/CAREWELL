 ...
 */
public class PillowactivityActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pillowactivity_main);
...
//        toggle.syncState();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_settings) {
            ...
            Intent intent = new Intent(PillowactivityActivity.this,Page1Activity.class);
            startActivity(intent);
            ...
            Intent intent = new Intent(PillowactivityActivity.this,WelcomeActivity.class);
            startActivity(intent);
